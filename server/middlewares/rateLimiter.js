...
const passwordResetLimiter = rateLimit({
  ...
  legacyHeaders: false,
  handler: (req, res, next) => {
    throw new APIError('Too many password reset attempts, please try again in 1 hour.', 429);
  },
});
...
const uploadLimiter = rateLimit({
  ...
  legacyHeaders: false,
  handler: (req, res, next) => {
    throw new APIError('Too many upload attempts, please try again later.', 429);
  },
});
